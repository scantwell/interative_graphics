...
void Model::load(const char* path)
{
	...
	//Cyan plastic?
	Material material(vec3(0.0, 0.1, 0.06), vec3(0.0, 0.50980392, 0.50196078), vec3(0.50196078, 0.50196078, 0.50196078));
	this->meshes.push_back(Mesh(vertices, indices, material, GL_TRIANGLES));
}
